...
\begin{tabbing}
    ...
    \textbf{2025 -- Present} \> Frontend Developer (Intern)  \> Extension Africa \\[0.1cm]
\end{tabbing}
\vspace{-0.3cm}
\begin{itemize}
    \item Building a mobile and web application using React, React Native and Expo for this organizatiom.
    \item Refractored and improved an old website for the organization.
    \item Designed onboarding, login/signup, forms and all UI with responsive layouts.
    \item Collaborated with a team of 13+ using Zoho and other social platform.
\end{itemize}
